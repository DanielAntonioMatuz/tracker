'use strict'
const datos = use('App/models/Vista');
...
class VistaController {
  ...
  /**
   * Render a form to be used for creating a new vista.
   * GET vistas/create
   *
   * @param {object} ctx
   * @param {Request} ctx.request
  ...
  async show ({ params, request, response, view }) {
    let alumno = await datos.find(params.id);
    return view.render('vista.index', {alumno:alumno});
  }

  /**
   * Render a form to update an existing vista.
   * GET vistas/:id/edit
   *
   * @param {object} ctx
   * @param {Request} ctx.request
